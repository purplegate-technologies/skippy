...
exports.Select = function (_a) {
    var _b = _a.label, label = _b === void 0 ? "" : _b, _c = _a.placeholder, placeholder = _c === void 0 ? "Select" : _c, value = _a.value, _d = _a.required, required = _d === void 0 ? true : _d, _e = _a.onChange, onChange = _e === void 0 ? function () { } : _e, _f = _a.options, options = _f === void 0 ? [] : _f, _g = _a.disabled, disabled = _g === void 0 ? false : _g, _h = _a.canNotEdit, canNotEdit = _h === void 0 ? false : _h, selectedOption = _a.selectedOption, className = _a.className;
    return (react_1["default"].createElement("div", { className: "space-y-2 flex flex-col " + (disabled && "opacity-60") },
        ...
        react_1["default"].createElement("div", { onClick: disabled && canNotEdit
                ...
                : function () { }, className: "border-2  border-[#DDDDDD] px-3 rounded-xlg  text-sm md:text-base" },
            react_1["default"].createElement("select", { value: value, defaultValue: value, 
                //   id={id}
                disabled: disabled, onChange: function (e) { return onChange(e.target.value); }, className: className + " h-14  lg:h-10 border-none border-blue-600:: focus:outline-none w-full md:auto bg-white", required: required },
