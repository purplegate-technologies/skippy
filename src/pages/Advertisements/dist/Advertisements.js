...
var Advertisements = function () {
    var _a = react_1.useState(""), iconState = _a[0], setIconState = _a[1];
    ...
    var _b = react_1.useState(userData), externalGraph = _b[0], setExternalGraph = _b[1];
    var _c = react_1.useState(userData), internalGraph = _c[0], setInternalGraph = _c[1];
    var data = statsApis_1.useGetAdvertStatsQuery().data;
    var _d = AdvertsApiSlice_1.useGetAdvertAdminQuery({}), getAds = _d.data, isLoading = _d.isLoading, isFetching = _d.isFetching;
    ...
    var renderBody = function (item, index) { return (React.createElement("tr", { key: item === null || item === void 0 ? void 0 : item._id },
        ...
        React.createElement("td", { className: "py-2 px-4 " + ((item === null || item === void 0 ? void 0 : item.status) === 'active' ? 'bg-[#47EOAA] rounded-full' : 'bg-red-100 text-red-600 rounded-full') }, item === null || item === void 0 ? void 0 : item.status))
        ,
