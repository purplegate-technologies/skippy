...
var VoucherDetails = function () {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: "grid lg:grid-cols-7 bg-[#FCFCFF] lg:gap-x-10" },
            ...
            React.createElement("div", { className: "md:col-span-2 flex flex-col bg-white  items-center justify-between gap-8 mt-10 md:mt-0" },
                React.createElement("div", { className: 'flex flex-1 w-full rounded-lg p-2 items-center  bg-[#F1F3FF]' },
