...
var MyDetails = function () {
    var inputValues = react_1.useRef();
    var initialValues = {
        firstName: '',
        lastName: '',
        email: '',
    ...
    return (react_1["default"].createElement("div", { className: "max-w-3xl" },
        react_1["default"].createElement("form", { onSubmit: handleSubmit, className: "card -mb-5" },
            react_1["default"].createElement("div", { className: "grid md:grid-cols-2 gap-x-4 " },
                react_1["default"].createElement(Input_1["default"], { labelStyle: "", divStyle: "label w-full", className: "border-[#949AB1] border-1 rounded p-2 my-3 w-full", label: "FIRST NAME", name: "firstName", placeholder: "First Name", value: firstName, type: 'text', onChange: handleChange }),
                react_1["default"].createElement(Input_1["default"], { divStyle: "contactUs-form-lable", className: "border-[#949AB1] border-1 rounded p-2 my-3 w-full", label: "SURNAME", name: "lastName", placeholder: "SURNAME", value: lastName, type: 'text', onChange: handleChange })),
            react_1["default"].createElement("div", { className: "grid md:grid-cols-2 gap-x-4" },
            ...
            react_1["default"].createElement("div", { className: "grid md:grid-cols-2 gap-x-4" },
                ...
                react_1["default"].createElement(Input_1["default"], { divStyle: "contactUs-form-lable", className: "border-[#949AB1] border-1 rounded p-2 my-3 w-full", label: "CONFIRM PASSWORD", name: "confirmPassword", placeholder: "Confirm Password", type: "password", value: confirmPassword, onChange: handleChange })),
