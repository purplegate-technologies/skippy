    ...
    return (react_1["default"].createElement("section", null,
        ...
        react_1["default"].createElement("div", { className: "grid lg:grid-cols-2  gap-10" },
            react_1["default"].createElement("div", { className: "flex-1 flex flex-col bg-white" },
                isLoading ? "isFetching Videos" : (react_1["default"].createElement(react_1["default"].Fragment, null, isFetching ? react_1["default"].createElement(react_1["default"].Fragment, null,
                    "\"isFetching Videos\"",
                    react_1["default"].createElement("video", { autoPlay: true, muted: true, loop: true, id: "homeVideo" },
                        react_1["default"].createElement("source", { src: "https://socialarthouse.s3.us-east-2.amazonaws.com/Black.mp4", type: "video/mp4" }))) : (react_1["default"].createElement(video_1["default"], { options: videoJsOptions, onReady: handlePlayerReady })))),
                react_1["default"].createElement("video", { autoPlay: true, muted: true, loop: true, id: "homeVideo" },
                    react_1["default"].createElement("source", { src: "https://socialarthouse.s3.us-east-2.amazonaws.com/Black.mp4", type: "video/mp4" }),
