            ...
            react_1["default"].createElement("div", { className: 'md:basis-1/2 flex flex-col bg-white col-span-3' },
                ...
                tabIndex === "Scene" && (react_1["default"].createElement(react_1["default"].Fragment, null,
                    react_1["default"].createElement("div", { className: 'bg-white border p-3' },
                        ...
                        react_1["default"].createElement("div", { className: "flex items-center justify-between border flex-1 lg:mt-auto mt-10 rounded" },
                            react_1["default"].createElement("div", { className: "flex flex-col items-center border w-full p-2 cursor-pointer " + (tabIndexText === "Info" && "tabIndex text-[#516CF5] border-t-2 border-t-[#516CF5]") + "}", onClick: function () { return setTabIndexText("Add"); } },
                            ...
                            react_1["default"].createElement("div", { className: "flex flex-col items-center border w-full p-2 cursor-pointer " + (tabIndexText === "Info" && "tabIndex text-[#516CF5] border-t-2 border-t-[#516CF5]") + "}", onClick: function () { return setTabIndexText("Edit"); } },
                            ...
                            react_1["default"].createElement("div", { className: "flex flex-col items-center border w-full p-2 cursor-pointer " + (tabIndexText === "Info" && "tabIndex text-[#516CF5] border-t-2 border-t-[#516CF5]") + "}", onClick: function () { return setTabIndexText("Back"); } },
