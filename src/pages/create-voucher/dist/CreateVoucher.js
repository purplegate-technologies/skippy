    ...
    return (React.createElement("section", null,
        ...
        React.createElement("div", { className: "grid md:grid-cols-12 gap-10 m-5" },
                ...
                React.createElement("form", { className: "mb-5 " },
                    React.createElement("div", { className: "mb-1 w-full bg-gray-50 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600" },
                        React.createElement("div", { className: "flex justify-between items-center py-2 px-3 border-b dark:border-gray-600" },
                            ...
                            React.createElement("button", { type: "button", "data-tooltip-target": "tooltip-fullscreen", className: "p-2 text-gray-500 rounded cursor-pointer sm:ml-auto hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600" },
                                React.createElement("svg", { "aria-hidden": "true", className: "w-5 h-5", fill: "currentColor", viewBox: "0 0 20 20", xmlns: "http://www.w3.org/2000/svg" },
                                    React.createElement("path", { "fill-rule": "evenodd", d: "M3 4a1 1 0 011-1h4a1 1 0 010 2H6.414l2.293 2.293a1 1 0 11-1.414 1.414L5 6.414V8a1 1 0 01-2 0V4zm9 1a1 1 0 010-2h4a1 1 0 011 1v4a1 1 0 01-2 0V6.414l-2.293 2.293a1 1 0 11-1.414-1.414L13.586 5H12zm-9 7a1 1 0 012 0v1.586l2.293-2.293a1 1 0 111.414 1.414L6.414 15H8a1 1 0 010 2H4a1 1 0 01-1-1v-4zm13-1a1 1 0 011 1v4a1 1 0 01-1 1h-4a1 1 0 010-2h1.586l-2.293-2.293a1 1 0 111.414-1.414L15 13.586V12a1 1 0 011-1z", "clip-rule": "evenodd" })),
                                React.createElement("span", { className: "sr-only" }, "Voucher Description")),
                            React.createElement("div", { id: "tooltip-fullscreen", role: "tooltip", className: "inline-block absolute invisible z-10 py-2 px-3 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 transition-opacity duration-300 tooltip dark:bg-gray-700" },
                                "Show full screen",
            ...
            React.createElement("div", { className: 'md:col-span-5 flex flex-col bg-white' },
                React.createElement("div", { className: "border p-4 mb-" },
