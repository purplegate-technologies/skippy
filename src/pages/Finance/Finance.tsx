...
const Finance = () => {
  ...
  return (
    <div>
      ...
      <div className="card">
        <SearchBar className='' HeaderTitle='All Vouchers' placeholder='Enter Brand/Voucher Name' text="Create&nbsp;Voucher" onClick={() => navigate('/create-voucher')} prefixIcon={<CreateAdsPlus />} />
        <CategoryFilter />
        {/* Table */}
        <div className="row">
