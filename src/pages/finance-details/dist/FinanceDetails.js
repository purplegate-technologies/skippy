...
var FinanceDetails = function () {
    ...
    return (react_1["default"].createElement("section", null,
        ...
        react_1["default"].createElement("div", { className: "financedetails my-5 border rounded-xl shadow-sm p-4" },
            react_1["default"].createElement("div", { className: "flex items-center flex-col md:flex-row justify-between" },
                ...
                react_1["default"].createElement("div", { className: "flex items-center gap-3" },
                    react_1["default"].createElement("div", { className: "flex flex-col items-center cursor-pointer w-1/2 p-1" },
                        react_1["default"].createElement(react_router_dom_1.Link, { to: "/create-voucher" },
            ...
            react_1["default"].createElement("div", { className: "md:basis-1/2 flex flex-col" },
                react_1["default"].createElement("div", { className: 'self-center' },
                    ...
                    react_1["default"].createElement("div", { className: "bg-white" },
                        ...
                        react_1["default"].createElement("div", { className: "flex items-center gap-10 justfy-between" },
                            react_1["default"].createElement("div", null,
                            ...
                            react_1["default"].createElement(Button_1["default"], { onClick: function () { return navigate('create-voucher'); } }, "1500"))))),
